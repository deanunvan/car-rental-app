...
export const Luxury = () => {
  useEffect(() => {
    ScrollReveal().reveal('.color', { delay: 200, distance: '50px', duration: 1000, origin: 'bottom' });
    ScrollReveal().reveal('.vans-heading', { delay: 400, distance: '30px', duration: 1000, origin: 'bottom' });
